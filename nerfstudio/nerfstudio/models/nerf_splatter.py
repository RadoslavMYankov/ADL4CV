...
@dataclass
class NerfSplatterModelConfig(ModelConfig):
    """Splatfacto Model Config, nerfstudio's implementation of Gaussian Splatting"""

    _target: Type = field(default_factory=lambda: NerfSplatterModel)
...
class NerfSplatterModel(Model):
    ...
    config: NerfSplatterModelConfig
