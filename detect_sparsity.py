...
def compute_pose_overlap(images, rotation_weight=0.1, max_rotation_distance=0.8, rotation_penalty=10.):
    """
...
if __name__ == '__main__':
    ...
    # Convert to a set of ints
    lowest_density_images = set(lowest_density_images.values)
    ...
    cluster_df = pd.DataFrame({
        ...
        "image_name": [image.name for image in ims],
        "cluster_id": cluster_labels,
        "is_sparse": [int(image.image_id) in lowest_density_images for image in ims]
    })
